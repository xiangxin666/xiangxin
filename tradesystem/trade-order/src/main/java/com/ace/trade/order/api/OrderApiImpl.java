...
public class OrderApiImpl  implements IOrderApi {
    ...
    @ResponseBody
    public Result<ConfirmOrderRes> confirmOrder(@RequestBody  ConfirmOrderReq confirmOrderReq) {
        Result<ConfirmOrderRes> result=this.orderService.confirmOrder(confirmOrderReq);
        return result;
    }
}
